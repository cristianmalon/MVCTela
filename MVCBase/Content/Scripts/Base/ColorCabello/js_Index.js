$(document).ready(function () {
    $(window).load(function () {
        ...
        $("#btnBuscarColorCabello").click(function () {
            cargarGridcolorCabello();

        });

        $("#btnLimpiarColorCabello").click(function () {
            $("#descripcion").val('');
            $("#descripcion").focus();
        ...
        $("#addNewColorCabello").click(function () {
        ...
        $("#addModifyColorCabello").click(function () {


            var dataDetalleTipoLugarDS = $("#gridColorCabello").data("kendoGrid");
            var itemDataTipoLugarDS = dataDetalleTipoLugarDS.dataItem(dataDetalleTipoLugarDS.select());
            if (itemDataTipoLugarDS != undefined) {

                var url = $(this).attr('data-url') + '?Index=' + itemDataTipoLugarDS.XID_COLOR_CABELLO;
                var divModal = $(this).attr('data-div');
                var divContenedor = $(this).attr('data-contenedor');
...
function cargarGridcolorCabello() {

    $("#gridColorCabello").html('');
    ...
    var dataSource = new kendo.data.DataSource({
        transport: {
            read: {
                type: "POST",
                url: "/ColorCabello/ListarColorCabello",
    ...
    var grid = $("#gridColorCabello").kendoGrid({
        ...
        columns: [
            {
                field: "XID_COLOR_CABELLO",
                title: "ID_COLOR_CABELLO",
                hidden: true
            }, {
                field: "DESCRIPCION",
                title: "DESCRIPCIÓN",
