    ...
    $("#XID_CONTACTO").kendoComboBox({
        ...
        change: function () {
            ...
            if (cmb.selectedIndex < 0) {
                ...
                console.log($("#XID_CONTACTO").data("kendoComboBox").value());
            ...
            bootbox.confirm("¿Desea grabar el oficio?", function (res) {
                if (res) {
                    ...
                    var oOficio = {
                        ...
                        XID_DIRECTOR: $("#XID_DIRECTOR").val(),
                        XID_INSPECCION_BASE: $("#CT_GENM_INSPECCION_BASE_XID_INSPECCION_BASE").val(),
                    ...
                    $.ajax({
                        datatype: 'json',
                        contentType: "application/json",
                        url: '/OficioInspeccion/SaveOficioBase',
                        type: 'POST',
                        data: JSON.stringify({ oOficio: oOficio, objDataReferencia: objDataReferenciajax, objDataTrabajador: objDataTrabajadorajax }),
                        beforeSend: function () {
                            bloquoteObject();
                        },
                        success: function (data) {
                ...
                if (res) {
                    ...
                    */
                    ...
                    $.ajax({
                        datatype: 'json',
                        contentType: "application/json",
                        url: '/Reiterativo/SaveOficioBase',
                        type: 'POST',
    ...
    bootbox.confirm("¿Desea Validar el oficio?", function (res) {
        if (res) {
            $.ajax({
                datatype: 'json',
                contentType: "application/json",
                url: '/OficioInspeccion/ActualizarFlgValidar',
                type: 'POST',
                data: JSON.stringify({ Inspeccion_Base: $("#CT_GENM_INSPECCION_BASE_XID_INSPECCION_BASE").val() }),
                beforeSend: function () {
                    bloquoteObject();
                },
                success: function (data) {
