$(document).ready(function () {
    ...
    */
    ...
    if (tipo_inspeccion == 95 || tipo_inspeccion == 96 || tipo_inspeccion == 97 || tipo_inspeccion == 102 ||
        ...
        $("#lblProvincia").addClass("asterisco");
        $("#lblDistrito").addClass("asterisco");
        $("#XID_INSPECTOR").toggleDisable();
        $("#XID_INSPECTOR_OTRO").toggleDisable();
    }
        ...
        $("#lblProvincia").addClass("asterisco");
        $("#lblDistrito").addClass("asterisco");
    } else if (tipo_inspeccion == 181) {
        if ($("#CT_GENM_ACTIVIDAD_DS_XID_PERSONA_JURIDICA").val().trim() == $("#XSIN_EMPRESA").val().trim()) {
            $("#lblDNI").addClass("asterisco");
            $("#DivDNI").show();
        }
    } else {
        $("#DivMatricula").show();
    ...
    $("#btnModifyDiscrepancia").click(function () {
        ...
        if (selectedRows.length == 0 || selectedRows.length > 1) {
            ...
            modalAjaxRequestGet2(url, "", "", 'Discrepancia=' + itemDataDiscrepancia.XDISCREPANCIA + '&cord_tec=' + "aeronavegavilidad");
        }
    });
    ...
    /*
    $("#btnVerOficiosBase").click(function () {
        var url = $(this).attr('data-url');
        modalAjaxRequestGet2(url, "", "", "");
    });
    */
    ...
    if (inspecion == "") {
        ...
        console.log(valtipoinspeccion);
        console.log(coordinaciontecnica);
...
function ComboboxTipoLugar() {
    ...
    var tipo_inspeccion_l = $("#CT_GENM_ACTIVIDAD_DS_ID_TIPO_INSPECCION").val();
