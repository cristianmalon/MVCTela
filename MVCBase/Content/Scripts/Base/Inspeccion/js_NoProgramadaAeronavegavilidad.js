$(document).ready(function () {
    ...
    */
    ...
    $("#btnAddDiscrepancia").click(function () {
        ...
        if (validaInspeccion()) {
            modalAjaxRequestGet2("/Discrepancia/Discrepancia", "", "", 'cord_tec=' + "aeronavegavilidad");
        }
    });
...
function validaInspeccion() {
    ...
    if ($("#FLG_RESULT_INSPECCION_BASE").val() == 'true') {        
        ...
        if ($("#XID_INSPECTOR_OTRO").data("kendoMultiSelect").value() == null || $("#XID_INSPECTOR_OTRO").data("kendoMultiSelect").value() == "") {
            flg = false;
            $('[aria-owns="XID_INSPECTOR_OTRO_taglist XID_INSPECTOR_OTRO_listbox"]').parent("div").addClass("valError");
...
function ComboboxTipoLugar() {
    ...
    if (tipo_inspeccion_l == 83 || tipo_inspeccion_l == 112 || tipo_inspeccion_l == 113 || tipo_inspeccion_l == 114 || tipo_inspeccion_l == 115) {
        $("#DivAerodromoFin").hide();
        $("#DivHelipuertoFin").hide();
    }
