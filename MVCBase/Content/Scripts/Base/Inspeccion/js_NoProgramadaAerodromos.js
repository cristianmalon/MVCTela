$(document).ready(function () {
    ...
    $("#XID_AERODROMO_PERSONA_JURIDICA").css({ "width": "100%"}).kendoComboBox({
        ...
        change: function () {
            ...
            if (cmb.selectedIndex < 0) {
                ...
                if ($.trim($("#XID_AERODROMO_PERSONA_JURIDICA").data("kendoComboBox").value()) != "" && $("#XID_AERODROMO_PERSONA_JURIDICA").data("kendoComboBox").value() != null) {
                    $.ajax({
                        datatype: 'json',
                        url: '/Inspeccion/DetalleAerodromoEmpresa',
                        type: 'POST',
                        contentType: "application/json",
                        data: JSON.stringify({
                            XAERODROMO: $.trim($("#XID_AERODROMO_PERSONA_JURIDICA").data("kendoComboBox").value())
                        }),
                        beforeSend: function () {
                            bloquoteObject();
                        },
                        success: function (data) {
                            ...
                            if (!data.rpta) {
                                ...
                                $("#CT_GENM_ACTIVIDAD_DS_ID_AERODROMO").val(data.IdAerodromo);
                                $("#CT_GENM_ACTIVIDAD_DS_XID_AERODROMO").val(data.XIdAerodromo);
                                $("#CT_GENM_ACTIVIDAD_DS_ID_HELIPUERTO").val(data.IdHelipuerto);
                                $("#CT_GENM_ACTIVIDAD_DS_XID_HELIPUERTO").val(data.XIdHelipuerto);
                                
                                if (data.IdAerodromo > 0) {
                                    $("#CT_MAE_TIPO_LUEGAR_DS_XTIPO_LUGAR_DS").data("kendoComboBox").value($("#XCB_ID_AERODROMO").val());
                                    $("#CT_MAE_AERODROMO_XAERODROMO").data("kendoComboBox").value(data.XIdAerodromo);
                                    $("#DivHelipuertoInicio").hide();
                                    $("#DivAerodromoInicio").hide();
                                    $("#DivTipoLugar").hide();
                                    $("#DivDepartamento").hide();
                                ...
                                else if (data.IdHelipuerto) {
                                    $("#CT_MAE_TIPO_LUEGAR_DS_XTIPO_LUGAR_DS").data("kendoComboBox").value($("#XCB_ID_HELIPUERTO").val());
                                    $("#CT_GENM_HELIPUERTO_XHELIPUERTO").data("kendoComboBox").value(data.XIdHelipuerto);
                                    $("#DivHelipuertoInicio").hide();
                                    $("#DivAerodromoInicio").hide();
                                    $("#DivTipoLugar").hide();
                                    $("#DivDepartamento").hide();
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (!data.rpta) {
                                ...
                                $("#XID_AERODROMO_PERSONA_JURIDICA").data("kendoComboBox").value('');
                                var multiselect = $("#XID_AERODROMO_PERSONA_JURIDICA").data("kendoComboBox");
        ...
        change: function () {
            ...
            if (cmb.selectedIndex < 0) {
                ...
                if ($.trim($("#CT_GENM_ACTIVIDAD_DS_ID_PERSONA_JURIDICA").data("kendoComboBox").value()) != "" && $("#CT_GENM_ACTIVIDAD_DS_ID_PERSONA_JURIDICA").data("kendoComboBox").value() != null) {
                    $.ajax({
                        datatype: 'json',
                        url: '/Inspeccion/CargarMatriculaAerodromo',
                        type: 'POST',
                        contentType: "application/json",
                        data: JSON.stringify({
                            XPERSONA_JURIDICA: $.trim($("#CT_GENM_ACTIVIDAD_DS_ID_PERSONA_JURIDICA").data("kendoComboBox").value().split('^')[0]),
                            Giro: $.trim($("#CT_GENM_ACTIVIDAD_DS_XID_GIRO").data("kendoComboBox").value())
                        }),
                        beforeSend: function () {
                            bloquoteObject();
                        },
                        success: function (data) {
                            ...
                            if (!data.rpta) {
                                ...
                                if (data.l_T_Mae_Aerodromo.length > 0) {
                                    $("#XID_AERODROMO_PERSONA_JURIDICA").data("kendoComboBox").value('');
                                    var multiselect = $("#XID_AERODROMO_PERSONA_JURIDICA").data("kendoComboBox");
                                    multiselect.setDataSource(data.l_T_Mae_Aerodromo);
                                    $("#divOpcionAerodromoHelipuerto").show();
                                    $("#hdHelipuertoAerodromo").val("1");
                                }
                                else {
                                    $("#XID_AERODROMO_PERSONA_JURIDICA").data("kendoComboBox").value('');
                                    var multiselect = $("#XID_AERODROMO_PERSONA_JURIDICA").data("kendoComboBox");
                                    multiselect.setDataSource([]);
                                    $("#divOpcionAerodromoHelipuerto").hide();
                                    $("#hdHelipuertoAerodromo").val("0");
                                }
                            }
                            desbloqObject();
                        }
...
function validaInspeccion() {
    ...
    if (($("#hdHelipuertoAerodromo").val("1")) && ($("#XID_AERODROMO_PERSONA_JURIDICA").val().trim() == "")) {
        flg = false;
        $('[aria-owns="XID_AERODROMO_PERSONA_JURIDICA_listbox"]').parents("span").addClass("valError");
        objData.push({ "XID_AERODROMO_PERSONA_JURIDICA": [{ ErrorMessage: "Debe seleccionar un aerodromo" }] })
    }
