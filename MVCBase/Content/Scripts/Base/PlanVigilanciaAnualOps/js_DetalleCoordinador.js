$(document).ready(function () {
    $(window).load(function () {
            ...
            change: function () {
                ...
                if (cmb.selectedIndex < 0) {
                    ...
                    if ($.trim($("#XID_PERSONA_JURIDICA").data("kendoComboBox").value()) != "" && $("#XID_PERSONA_JURIDICA").data("kendoComboBox").value() != null) {
                        $.ajax({
                            datatype: 'json',
                            url: '/PlanVigilanciaAnualOps/DetalleCertificacion',
                            type: 'POST',
            ...
            change: function () {
                ...
                if (cmb.selectedIndex < 0) {
                    ...
                    if ($.trim($("#XID_GIRO").data("kendoComboBox").value()) != "" && $("#XID_GIRO").data("kendoComboBox").value() != null) {
                        $.ajax({
                            datatype: 'json',
                            url: '/PlanVigilanciaAnualOps/GiroPersonaJuridica',
                            type: 'POST',
                            contentType: "application/json",
                            data: JSON.stringify({
        ...
        $("#FrmPlanVigilanciaAnual").on("click", ".InspeccionesProgramadasMes", function () {
            ...
            $.ajax({
                url: '/PlanVigilanciaAnualOps/DetalleMesCoordinador?Index=' + Index,
                type: "GET",
                beforeSend: function () {
                    bloquoteModal();
                },
                            ...
                            success: {
                                ...
                                callback: function () {
                                    if ($.trim($("#txtObservacion").val()).length > 0) {
                                        ...
                                        $.ajax({
                                            datatype: 'json',
                                            url: '/PlanVigilanciaAnualOps/DesaprobarMasivoCoordinador',
                                            type: 'POST',
                                            contentType: "application/json",
                                            data: JSON.stringify({
            ...
            if (contBlur == 1) {
                try {
                    if ($(this).val() >= 0) {
                        ...
                        $.ajax({
                            datatype: 'json',
                            url: '/PlanVigilanciaAnualOps/RegistroInspeccionCoordinadorCantidad',
                            type: 'POST',
                            contentType: "application/json",
                            data: JSON.stringify({
                                Cantidad: valObject, o_T_Genm_Plan_Vigi_Anual_DS: o_T_Genm_Plan_Vigi_Anual_DS
        ...
        $("#btnFiltroPlanVigilanciaAnual").click(function () {
            if ($("#XID_GIRO").data("kendoComboBox").value() == null || $("#XID_GIRO").data("kendoComboBox").value() == "") {
                ...
                if ($("#XID_PERSONA_JURIDICA").data("kendoComboBox").value() == null || $("#XID_PERSONA_JURIDICA").data("kendoComboBox").value() == "") {
                    ...
                    $.ajax({
                        datatype: 'json',
                        url: '/PlanVigilanciaAnualOps/FiltroPlanAnualCoord',
                        type: 'POST',
                        contentType: "application/json",
                        data: JSON.stringify({
                            Giro: $.trim($("#XID_GIRO").data("kendoComboBox").value()),
