    ...
    $("#btnGuardarInspeccionProgramada").click(function () {
        if (validRegistroInspección()) {
            ...
            $.ajax({
                ...
                url: '/PlanVigilanciaAnualOps/ReprogramacionCoordinador',
                type: 'POST',
...
function loadProvincia(valor) {
    $.ajax({
        datatype: 'json',
        url: '/PlanVigilanciaAnualOps/CargarProvincia?Index=' + valor,
        contentType: "application/json",
        beforeSend: function () {
            bloquoteObject();
        },
...
function loadDistrito(valor) {
    $.ajax({
        datatype: 'json',
        url: '/PlanVigilanciaAnualOps/CargarDistrito?Index=' + valor,
        contentType: "application/json",
        beforeSend: function () {
            bloquoteObject();
        },
