    ...
    $("#btnGuardarInspeccionProgramada").click(function () {
        if (validRegistroInspección()) {
            ...
            $.ajax({
                ...
                url: '/PlanVigilanciaAnualAvsec/RegistroInspeccionInspector',
                type: 'POST',
...
function loadProvincia(valor) {
    $.ajax({
        datatype: 'json',
        url: '/PlanVigilanciaAnualAvsec/CargarProvincia?Index=' + valor,
        contentType: "application/json",
        beforeSend: function () {
            bloquoteObject();
        },
...
function loadDistrito(valor) {
    $.ajax({
        datatype: 'json',
        url: '/PlanVigilanciaAnualAvsec/CargarDistrito?Index=' + valor,
        contentType: "application/json",
        beforeSend: function () {
            bloquoteObject();
        },
