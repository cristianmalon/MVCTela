$(document).ready(function () {
    ...
    $("#btnRegistrarNuevaInspeccionCoMes").click(function () {
        modalAjaxRequestGet($(this).attr("data-url"), "", "", "Giro=" + $("#FrmListaInspeccionAnualMes input[name=XID_GIRO]").val());
    });
    $("#btnVerInspeccion").click(function () {
        ...
        if (itemData != null) {
            ...
            modalAjaxRequestGet(url, "", "", "Index=" + itemData.XID_PLAN_VIGI_ANUAL_DS + "&Giro=" + itemData.XID_GIRO);
        }
        else {
            bootbox.alert("Seleccione un registro de la tabla");
        }
        ...
        transport: {
            ...
            parameterMap: function (options, operation) {
                ...
                var o_T_Genm_Plan_Vigi_Anual_DS = {
                    XID_GIRO: $("#FrmListaInspeccionAnualMes input[name=XID_GIRO]").val(),
                    XID_HABILITACION: $("#FrmListaInspeccionAnualMes input[name=XID_HABILITACION]").val(),
                    XID_PERSONA_JURIDICA: $("#FrmListaInspeccionAnualMes input[name=XID_PERSONA_JURIDICA]").val(),
                    XID_MES: $("#XID_MES_FILTRO_LISTA").data("kendoComboBox").value(),
                    XCIUDAD: $("#FrmListaInspeccionAnualMes input[name=XCIUDAD]").val(),
                    XID_TIPO_INSPECCION: $("#XID_TIPO_INSPECCION_FILTRO_LISTA").data("kendoComboBox").value(),
                    XID_PLAN_VIGILANCIA_DS: $("#XID_PLAN_VIGILANCIA_DS").val(),
                    XID_ESTADO_PLAN_VIGI_ANUALDS: $("#XID_ESTADO_PLAN_VIGI_ANUALDS").val(),
                    XID_AERODROMO : "0"
                };
