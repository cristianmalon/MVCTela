...
$(document).ready(function () {
    ...
    $("#btnFiltroEmpresas").click(function () {
        $("#filtroEmpresas").show();
        ajaxEmpresas();
    });
...
function gridTipoInspecEmpCoordDS(data, lObjeto) {
        ...
        schema: {
            model: {
                ...
                fields: {
                    ...
                    ID_PERSONA_JURIDICA: { validation: { required: true, message: 'Ingrese el Numero de Parte' }, defaultValue: { ID_PERSONA_JURIDICA: '', RAZON_SOCIAL: "[SELECCIONE]" } },
                    MES: { type: "string" },
    ...
    $("#gridTipoInspecEmpCoordDS").kendoGrid({
        ...
        columns: [
            ...
            { field: "MES", title: "MES", width: "80px" },
            {
                field: "FLG_ESTADO",
                title: "ACTIVO?",
...
$("#btnAddTipoInspecEmpCoordDS").click(function () {
    ...
    $("#gridTipoInspecEmpCoordDS")
                        ...
                        .insert({
                            ...
                            ID_PERSONA_JURIDICA: { ID_PERSONA_JURIDICA: '', RAZON_SOCIAL: "[SELECCIONE]" },
                            MES: $.trim($("#ID_MES").data("kendoComboBox").text()),
                            FLG_ESTADO: ""
                        });
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (!data.rpta) {
                ...
                $.each(data.data, function (index, value) {
                    var Objeto = {
                        ID_PERSONA_JURIDICA: value.XPERSONAJURIDICA,
